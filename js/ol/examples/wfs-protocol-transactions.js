...
function init() {
    ...
    wfs = new OpenLayers.Layer.Vector("Editable Features", {
        ...
        protocol: new OpenLayers.Protocol.WFS({
            ...
            featureNS: "http://www.gisplatform.it", 
            //featureType: "restricted",
            featureType: "poly_bortone",
            geometryName: "the_geom",
            //schema: "http://demo.opengeo.org/geoserver/wfs/DescribeFeatureType?version=1.1.0&typename=og:restricted"
            schema: "/geoserver/wfs?service=wfs&version=1.1.0&request=DescribeFeatureType&typeName=gisplatform:nodes_it"
        })
    }); 
