var gridWindowSelezionati;
var modelloStore;
var id,snode,enode;

function riempiGriglia(storeModel){		
	
var max = layerAttivo[0].selectedFeatures.length;	
gridWindowSelezionati.setTitle(max + ' selected elements');
...
modelloStore = new Ext.data.JsonStore({
...
modelloColonne = new Ext.grid.ColumnModel([
		{header:'ID',			width: 80, sortable:true },
		{header:'Start Node',	width: 80, sortable:true },
	    {header:'End Node',		width: 80, sortable:true }
]);
